...
const test1 = baby.reduce((t, v) => {
  const [order, number] = v.split(' ')
  if(order === 'forward'){
    t.horizontal += Number(number)
  }
  if(order === 'down'){
    t.depth += Number(number)
  }
  if(order === 'up'){
    t.depth -= Number(number)
  }
...
console.log(test1.horizontal * test1.depth)

const real1 = arr.reduce((t, v) => {
  const [order, number] = v.split(' ')
  if(order === 'forward'){
    t.horizontal += Number(number)
  }
...
console.log(real1.horizontal * real1.depth)

const test2 = baby.reduce((t, v) => {
  const [order, number] = v.split(' ')
  if(order === 'forward'){
    t.horizontal += Number(number)
    t.depth += t.aim * Number(number)
  }
  if(order === 'down'){
    t.aim += Number(number)
  }
...
console.log(test2.horizontal * test2.depth)

const real2 = arr.reduce((t, v) => {
  const [order, number] = v.split(' ')
  if(order === 'forward'){
    t.horizontal += Number(number)
    t.depth += t.aim * Number(number)
...
console.log(real2.horizontal * real2.depth)